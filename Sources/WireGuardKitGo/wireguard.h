...
extern int wgTurnOnMultihop(const char *exitSettings, const char *entrySettings, const char *privateIp, int32_t tun_fd, const char *maybenotMachines, unsigned int maybeNotMaxEvents, unsigned int maybeNotMaxActons);
